...
<template>
	<tr>
		<td>{{ item.id }}</td>
		<td class="td-center"><v-text-field v-model="localUser.firstName" hide-details></v-text-field></td>
		<td class="td-center"><v-text-field v-model="localUser.lastName" hide-details></v-text-field></td>
		<td class="td-center"><v-text-field v-model="localUser.email" hide-details></v-text-field></td>
		<td class="td-center">
			<v-date-input :model-value="localLastVisitedAt" @update:model-value="onLastVisitedAtChange" hide-details />
		</td>
		<td class="td-center">
